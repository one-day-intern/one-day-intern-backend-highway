...
GOOGLE_AUTH_LOGIN_REGISTER_ASSESSEE_REDIRECT_URI = os.getenv('GOOGLE_AUTH_LOGIN_ASSESSEE_REDIRECT_URI')

GOOGLE_AUTH_LOGIN_ASSESSOR_REDIRECT_URI = os.getenv('GOOGLE_AUTH_LOGIN_ASSESSOR_REDIRECT_URI')
GOOGLE_AUTH_REGISTER_ASSESSOR_REDIRECT_URI = os.getenv('GOOGLE_AUTH_REGISTER_ASSESSOR_REDIRECT_URI')

GOOGLE_AUTH_CLIENT_ASSESSEE_CALLBACK_URL = os.getenv('GOOGLE_AUTH_CLIENT_ASSESSEE_CALLBACK_URL')
GOOGLE_AUTH_CLIENT_ASSESSOR_CALLBACK_URL = os.getenv('GOOGLE_AUTH_CLIENT_ASSESSOR_CALLBACK_URL')
